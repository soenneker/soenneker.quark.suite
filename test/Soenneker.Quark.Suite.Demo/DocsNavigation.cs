...
public static class DocsNavigation
{
    ...
    [
        ...
        new("Details Item", ComponentRoute("details-item"), IsNew: true),
        new("Details Section", ComponentRoute("details-section"), IsNew: true),
        ...
        new("Page Header", ComponentRoute("page-header"), IsNew: true),
        ...
        new("Searchable Select", ComponentRoute("searchable-select"), IsNew: true),
        new("Suggestions", ComponentRoute("suggestions")),
        new("Table Empty State", ComponentRoute("table-empty-state"), IsNew: true),
