...
public static class DocsNavigation
{
    ...
    [
        ...
        new("Citation", "citation", IsNew: true),
        new("Message", "message", IsNew: true),
        ...
        new("Reasoning", "reasoning", IsNew: true),
        ...
        new("Text Shimmer", "text-shimmer", IsNew: true),
        new("Toast", "toast"),
