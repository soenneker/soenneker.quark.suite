...
{
    [Test]
    public void Text_destructive_maps_to_text_destructive()
    {
        TextColor.Destructive.ToClass().Should().Be("text-destructive");
    }

    [Test]
    public void Text_primary_foreground_maps_to_text_primary_foreground()
    {
        TextColor.PrimaryForeground.ToClass().Should().Be("text-primary-foreground");
    }

    [Test]
    public void Bg_card_maps_to_bg_card()
    {
        BackgroundColor.Card.ToClass().Should().Be("bg-card");
    }

    [Test]
    public void Bg_danger_alias_maps_to_bg_destructive()
    {
        BackgroundColor.Destructive.ToClass().Should().Be("bg-destructive");
    }

    [Test]
    public void Border_input_maps_to_border_input()
    {
        BorderColor.Input.ToClass().Should().Be("border-input");
    }

    [Test]
    public void Ring_destructive_maps_to_ring_destructive()
    {
    ...
    [Test]
    public void Bg_utility_passthrough_maps_directly()
    {
