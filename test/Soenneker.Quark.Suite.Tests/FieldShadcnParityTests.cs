...
public sealed partial class RenderedShadcnParityTests
{
    ...
    public void FieldLabel_matches_shadcn_base_classes()
    {
        ...
        classes.Should().Contain("has-data-checked:bg-primary/5");
        classes.Should().Contain("has-[>[data-slot=field]]:rounded-lg");
        classes.Should().Contain("*:data-[slot=field]:p-2.5");
        classes.Should().Contain("dark:has-data-checked:border-primary/20");
        classes.Should().Contain("dark:has-data-checked:bg-primary/10");
