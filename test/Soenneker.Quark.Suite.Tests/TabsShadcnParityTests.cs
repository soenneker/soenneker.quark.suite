...
public sealed partial class RenderedShadcnParityTests
{
    ...
    public void Tabs_slots_match_shadcn_base_classes()
    {
        ...
        var contents = cut.FindAll("[data-slot='tabs-content']");
        var listClasses = list.GetAttribute("class")!;
        var triggerClasses = trigger.GetAttribute("class")!;
        var contentClasses = contents[0].GetAttribute("class")!;
        ...
        tabsClasses.Should().NotContain("data-[orientation=horizontal]:flex-col");
        ...
        listClasses.Should().NotContain("group-data-[orientation=horizontal]/tabs:h-9");
        listClasses.Should().NotContain("q-tabs-list");
        list.GetAttribute("tabindex").Should().Be("0");
        ...
        triggerClasses.Should().Contain("px-1.5");
        triggerClasses.Should().Contain("py-0.5");
        ...
        triggerClasses.Should().Contain("group-data-horizontal/tabs:after:h-0.5");
        triggerClasses.Should().NotContain("data-[state=active]:bg-background");
        triggerClasses.Should().NotContain("px-2");
        triggerClasses.Should().NotContain("py-1");
        triggerClasses.Should().NotContain("group-data-[orientation=horizontal]/tabs:after:h-0.5");
        ...
        contents[0].HasAttribute("hidden").Should().BeFalse();
        contents[1].HasAttribute("hidden").Should().BeTrue();
    }
