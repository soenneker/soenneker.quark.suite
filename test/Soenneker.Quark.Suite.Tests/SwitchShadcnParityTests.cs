...
public sealed partial class RenderedShadcnParityTests
{
    ...
    public void Switch_matches_shadcn_default_component_contract()
    {
        ...
        rootClasses.Should().NotContain("data-[state=checked]:bg-primary");
        rootClasses.Should().NotContain("data-[state=unchecked]:bg-input");
        rootClasses.Should().NotContain("shadow-xs");
        rootClasses.Should().NotContain("focus-visible:ring-[3px]");
        rootClasses.Should().Contain("aria-invalid:border-destructive");
        rootClasses.Should().Contain("aria-invalid:ring-3");
        ...
        thumbClasses.Should().NotContain("data-[state=checked]:translate-x-[calc(100%-2px)]");
        thumbClasses.Should().NotContain("data-[state=unchecked]:translate-x-0");
        thumbClasses.Should().Contain("dark:data-checked:bg-primary-foreground");
        thumbClasses.Should().Contain("dark:data-unchecked:bg-foreground");
    }
}
