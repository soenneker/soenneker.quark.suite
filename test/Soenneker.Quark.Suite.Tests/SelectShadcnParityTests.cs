...
public sealed partial class RenderedShadcnParityTests
{
    ...
    public void Select_slots_match_shadcn_base_classes()
    {
        ...
        triggerClasses.Should().NotContain("gap-2");
        triggerClasses.Should().NotContain("rounded-md");
        triggerClasses.Should().NotContain("px-3");
        ...
        triggerClasses.Should().NotContain("data-[size=default]:h-9");
        triggerClasses.Should().NotContain("data-[size=sm]:h-8");
