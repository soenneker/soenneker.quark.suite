...
public sealed partial class RenderedShadcnParityTests
{
    ...
    public void Alert_matches_shadcn_base_classes()
    {
        ...
        alertClasses.Should().Contain("px-4");
        alertClasses.Should().Contain("py-3");
        ...
        alertClasses.Should().NotContain("group/alert");
        alertClasses.Should().NotContain("has-data-[slot=alert-action]:relative");
        alertClasses.Should().NotContain("px-2.5");
        alertClasses.Should().NotContain("py-2");
        alertClasses.Should().NotContain("*:[svg]:row-span-2");
