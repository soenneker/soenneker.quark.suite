...
public sealed partial class RenderedShadcnParityTests
{
    ...
    public void Check_matches_shadcn_checkbox_component_contract()
    {
        ...
        checkboxClasses.Should().NotContain("items-center");
        checkboxClasses.Should().NotContain("justify-center");
        checkboxClasses.Should().NotContain("transition-colors");
        checkboxClasses.Should().NotContain("after:absolute");
        checkboxClasses.Should().NotContain("after:-inset-x-3");
        checkboxClasses.Should().NotContain("after:-inset-y-2");
        checkboxClasses.Should().NotContain("focus-visible:ring-3");
        checkboxClasses.Should().NotContain("aria-invalid:ring-3");
        checkboxClasses.Should().NotContain("aria-invalid:aria-checked:border-primary");
        checkboxClasses.Should().NotContain("dark:aria-invalid:border-destructive/50");
        checkboxClasses.Should().NotContain("data-checked:border-primary");
        checkboxClasses.Should().NotContain("data-checked:bg-primary");
        checkboxClasses.Should().NotContain("data-checked:text-primary-foreground");
        checkboxClasses.Should().NotContain("data-[state=indeterminate]:border-primary");
        checkboxClasses.Should().NotContain("group-has-disabled/field:opacity-50");
        ...
        indicatorClasses.Should().NotContain("[&>svg]:size-3.5");
        indicator.InnerHtml.Should().NotContain("shrink-0");
    }
