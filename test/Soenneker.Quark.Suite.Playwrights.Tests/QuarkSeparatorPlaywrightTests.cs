...
[Fact]
    public async ValueTask Separator_examples_preserve_decorative_defaults_and_semantic_opt_in_metadata()
    {
        ...
        ILocator demoSection = page.Locator("section").Filter(new LocatorFilterOptions { HasText = "The shadcn separator layout with a horizontal rule above inline vertical dividers." }).First;
        ILocator decorativeHorizontal = demoSection.Locator("[data-slot='separator'][data-orientation='horizontal']").First;
        ILocator decorativeVerticals = demoSection.Locator("[data-slot='separator'][data-orientation='vertical']");
        ...
        ILocator semanticSection = page.Locator("section").Filter(new LocatorFilterOptions { HasText = "Non-decorative separators stay in the accessibility tree with the expected orientation metadata." }).First;
        ILocator semanticHorizontal = semanticSection.Locator("[data-slot='separator'][role='separator'][data-orientation='horizontal']").First;
        ILocator semanticVertical = semanticSection.Locator("[data-slot='separator'][role='separator'][data-orientation='vertical']").First;
