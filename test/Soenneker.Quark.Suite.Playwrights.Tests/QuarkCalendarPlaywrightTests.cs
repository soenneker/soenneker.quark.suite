...
public sealed class QuarkCalendarPlaywrightTests : PlaywrightUnitTest
{
    ...
    public async ValueTask Calendar_demo_matches_shadcn_daypicker_surface_and_selects_dates_without_errors()
    {
        ...
        await Assertions.Expect(dropdownRoot).ToHaveClassAsync(new System.Text.RegularExpressions.Regex("border-input"));
        await Assertions.Expect(dropdownRoot).ToHaveClassAsync(new System.Text.RegularExpressions.Regex("shadow-xs"));
