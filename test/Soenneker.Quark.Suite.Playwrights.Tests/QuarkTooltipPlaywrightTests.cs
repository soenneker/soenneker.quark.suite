...
[Test]
    public async ValueTask Tooltip_demo_hides_basic_content_after_pointer_leaves_trigger_and_content()
    {
        ...
        var basicSection = page.Locator("section").Filter(new LocatorFilterOptions { HasText = "Tooltips work well for terse helper text on icon buttons and compact controls." }).First;
        var basicTrigger = basicSection.GetByRole(AriaRole.Button, new LocatorGetByRoleOptions { Name = "Hover", Exact = true });
        var basicTooltip = page.Locator("[data-slot='tooltip-content'][data-state='instant-open'], [data-slot='tooltip-content'][data-state='delayed-open']")
...
[Test]
    public async ValueTask Tooltip_demo_transfers_open_state_between_sibling_triggers()
    {
        ...
        var openTopTooltip = page.Locator("[data-slot='tooltip-content'][data-state='instant-open'], [data-slot='tooltip-content'][data-state='delayed-open']")
                                 .Filter(new LocatorFilterOptions { HasText = "Default placement" });
        var openRightTooltip = page.Locator("[data-slot='tooltip-content'][data-state='instant-open'], [data-slot='tooltip-content'][data-state='delayed-open']")
...
[Test]
    public async ValueTask Tooltip_demo_supports_nested_tooltip_inside_modal_dialog()
    {
        ...
        var tooltip = page.Locator("[data-slot='tooltip-content'][data-state='instant-open'], [data-slot='tooltip-content'][data-state='delayed-open']")
