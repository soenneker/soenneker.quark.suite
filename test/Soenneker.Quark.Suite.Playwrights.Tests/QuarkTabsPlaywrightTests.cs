...
[Fact]
    public async ValueTask Tabs_manual_activation_moves_focus_without_selection_until_space_or_enter()
    {
        ...
        var manualSection = page.Locator("section").Filter(new LocatorFilterOptions { HasText = "Radix manual mode: arrow keys move focus; Space or Enter activates the focused tab" }).First;
...
[Fact]
    public async ValueTask Tabs_vertical_and_rtl_examples_follow_orientation_and_direction_keyboard_rules()
    {
        ...
        var rtlSection = page.Locator("section").Filter(new LocatorFilterOptions { HasText = "Tabs respect inherited direction in right-to-left layouts." }).First;
...
[Fact]
    public async ValueTask Tabs_disabled_and_controlled_examples_respect_selection_rules()
    {
        ...
        var disabledSection = page.Locator("section").Filter(new LocatorFilterOptions { HasText = "Disabled triggers are skipped by keyboard navigation and cannot be selected." }).First;
...
[Fact]
    public async ValueTask Tabs_demo_switches_selected_trigger_and_visible_panel()
    {
        ...
        var demoSection = page.Locator("section").Filter(new LocatorFilterOptions { HasText = "The shadcn account/password tabs layout using explicit list, trigger, and content composition." }).First;
