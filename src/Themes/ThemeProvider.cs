...
public sealed class ThemeProvider : IThemeProvider
{
    ...
    public Dictionary<string, Func<Theme, ComponentOptions?>> ComponentOptions { get; set; } = new()
    {
        ...
        // Table components
        ["Tr"] = theme => theme.Trs,
        ["Thead"] = theme => theme.Theads,
        ["Td"] = theme => theme.Tds,
        ["Tbody"] = theme => theme.Tbodys,
        ["Th"] = theme => theme.Ths,
        ["Table"] = theme => theme.Tables,
        ["TableSearch"] = theme => theme.TableSearches,
        ["TablePagination"] = theme => theme.TablePaginations,
        ["TablePageSizeSelector"] = theme => theme.TablePageSizeSelectors,
        ["TableNoData"] = theme => theme.TableNoDatas,
        ["TableLoader"] = theme => theme.TableLoaders,
        ["TableInfo"] = theme => theme.TableInfos,
        ["TableElement"] = theme => theme.TableElements,
        ["TableTopBar"] = theme => theme.TableTopBars,
        ["TableBottomBar"] = theme => theme.TableBottomBars,
        ["TableLeft"] = theme => theme.TableLefts,
        ["TableRight"] = theme => theme.TableRights,
