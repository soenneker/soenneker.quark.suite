...
/// <summary>
/// An enumeration for Quark, representing grid column size values.
/// Maps to Tailwind grid column classes (e.g. col-1, col-2) for layout.
/// </summary>
[EnumValue<string>]
