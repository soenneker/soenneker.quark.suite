...
public static class ThemeTailwindCssGenerator
{
    ...
    private static void AppendScheme(StringBuilder builder, string selector, ThemeTokenScheme scheme)
    {
        ...
        AppendVariable(builder, "series-1", scheme.Series.First);
        AppendVariable(builder, "series-2", scheme.Series.Second);
        AppendVariable(builder, "series-3", scheme.Series.Third);
        AppendVariable(builder, "series-4", scheme.Series.Fourth);
        AppendVariable(builder, "series-5", scheme.Series.Fifth);
    ...
    private static void AppendInlineTheme(StringBuilder builder, IReadOnlyDictionary<string, string> inlineVariables)
    {
        ...
        AppendVariable(builder, "color-series-1", "var(--series-1)");
        AppendVariable(builder, "color-series-2", "var(--series-2)");
        AppendVariable(builder, "color-series-3", "var(--series-3)");
        AppendVariable(builder, "color-series-4", "var(--series-4)");
        AppendVariable(builder, "color-series-5", "var(--series-5)");
